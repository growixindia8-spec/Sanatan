...
export default function MonthlyGiving() {
  ...
  const handleStartDonation = (amount) => {
    navigate(`/donate?amount=${amount}&contributionType=monthly`);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="bg-cream p-8 rounded-2xl shadow border border-gray-100">
            ...
            <button 
              type="button"
              onClick={() => handleStartDonation(500)}
              className="w-full bg-charcoal text-white py-3 rounded-full font-bold mb-6 hover:bg-gray-800 cursor-pointer"
            >
              नित्य दान प्रारंभ करें
            </button>
          ...
          <div className="bg-maroon text-white p-8 rounded-2xl shadow-2xl transform md:-translate-y-4 relative">
            ...
            <button 
              type="button"
              onClick={() => handleStartDonation(2100)}
              className="w-full bg-gold text-charcoal py-3 rounded-full font-bold mb-6 hover:bg-yellow-500 cursor-pointer"
            >
              नित्य दान प्रारंभ करें
            </button>
          ...
          <div className="bg-cream p-8 rounded-2xl shadow-2xl border border-gray-100 animate-none">
            ...
            <button 
              type="button"
              onClick={() => handleStartDonation(1100)}
              className="w-full bg-charcoal text-white py-3 rounded-full font-bold mb-6 hover:bg-gray-800 cursor-pointer"
            >
              नित्य दान प्रारंभ करें
            </button>
