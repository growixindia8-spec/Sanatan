        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="space-y-5 text-gray-700 font-devanagari leading-relaxed text-[15px] md:text-base">
              <p>
                सनातन धर्म मानव कल्याण फाउंडेशन भारत सरकार के कंपनी अधिनियम, 2013 की धारा 8 के अंतर्गत पंजीकृत एक Professionally Managed गैर-लाभकारी संस्था है, जो <strong className="text-charcoal font-semibold">सेवा, संस्कार, सामाजिक उत्तरदायित्व एवं मानव कल्याण</strong> के मूल्यों पर कार्य करती है।
              </p>
              <p>
                हमारा उद्देश्य <strong className="text-charcoal font-semibold">सनातन संस्कृति एवं भारतीय मूल्यों का संरक्षण, मानव सेवा को प्रोत्साहन</strong> तथा समाज के अंतिम व्यक्ति तक सहायता, सम्मान और अवसर पहुँचाना है। संस्था समाज में सकारात्मक एवं स्थायी परिवर्तन लाने के लिए सेवा, जागरूकता, सहयोग और जनभागीदारी को एक सशक्त माध्यम मानती है।
              </p>
              <p>
                फाउंडेशन <strong className="text-charcoal font-semibold">अन्न सेवा, चिकित्सा एवं स्वास्थ्य सहायता, शिक्षा एवं संस्कार सहयोग, महिला सुरक्षा एवं सम्मान, आपदा राहत, गौ सेवा</strong>, पर्यावरण संरक्षण, सांस्कृतिक जनजागरण तथा विभिन्न मानव कल्याण परियोजनाओं के माध्यम से जरूरतमंद व्यक्तियों, परिवारों एवं समुदायों तक सहायता पहुँचाने का प्रयास कर रहा है।
              </p>
              <p>
                हमारी सभी पहल <strong className="text-charcoal font-semibold">पारदर्शिता, उत्तरदायित्व, सत्यापन एवं सेवा भावना</strong> के सिद्धांतों पर आधारित हैं, ताकि प्रत्येक सहयोग सही उद्देश्य तक पहुँचे और समाज में विश्वास, सहभागिता एवं सकारात्मक परिवर्तन को सशक्त बनाया जा सके।
              </p>
            </div>
          </div>
